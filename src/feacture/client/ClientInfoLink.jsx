    ...
    <>
      ...
      >
        <div className=" flex  justify-between space-x-6 items-center">
          <img src="data\image\Image\pf-logo.svg" alt="lineicon" className="max-w-[80px] sm:max-w-[250px]" />
          <img src="data\image\Image\coppellconservatory-logo-light.png" alt="plainadmin" className="max-w-[60px] sm:max-w-[150px]" />
